...
write.csv(slope_long, paste0(inPath, 'pft_slopes_caribou_density_seasonal.csv'), row.names = FALSE)
...
outName = paste0('fig_s22_caribou_density_season_pfts_sens_slopes.jpg')
...
outName = paste0('fig_s23_caribou_density_season_shrubs_sens_slopes.jpg')
